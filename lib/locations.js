...
router.get('/', (req, res, next) => {
    ...
    Location.find()
        ...
        .select('_id name likes')/*/address city description category raggiungibilita locationImage photoDesc hour date likes')*/
        .exec()
        .then(docs => {
...
router.delete('/:locationId', (req, res, next) => {
    ...
    .exec()
    .then(result => {
        console.log(result.locationImage, typeof(result.locationImage));
